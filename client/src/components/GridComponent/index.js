...
addDataBack = (dataTitle) =>{
    this.props.data != undefined ? this.props.data.values.unshift(dataTitle) : null
}
  render() {
...
//    }
    const dataTitle =  this.props.data != undefined ? this.props.data.values.shift() : null
    ...
    <GridWrapper>
        ...
        <table className="table is-fullwidth is-striped">
            <thead>
                <tr>
                { this.props.data != undefined ?  dataTitle.map((value,index) => <th key={index}>{value}</th>) : <th>Loading</th>}    
                </tr>
            </thead>
            <tbody>  
